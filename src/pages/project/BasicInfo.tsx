                ...
                items={[
                  {
                    ...
                    desc: '전기 고지서·거래명세서와 같은 실제 증빙을 올려 데이터를 추출하고 탄소발자국을 계산합니다. 값이 정확해 탄소 회계 산정 결과를 담은 문서를 받아볼 수 있고, 이 문서는 제3자 검증을 거쳐 인증이나 납품처 제출에 활용할 수 있습니다. 대신 준비할 서류가 조금 더 많습니다. (MRV = 측정·보고·검증. 인증 활용을 위한 외부 검증은 LCA 컨설팅 기관 등 제3자가 별도로 수행)',
                  },
                  {
