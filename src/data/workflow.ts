...
export const ALL_STEPS: WorkflowStep[] = [
  ...
  { key: 'materials', label: '원부자재', title: '제조전단계 · 원부자재', phase: '제조전', req: true, ocr: true },
  { key: 'transport', label: '원료 수송', title: '제조전단계 · 원료 수송', phase: '제조전', req: true, ocr: true },
  { key: 'mass', label: '질량기여도', title: '누적질량기여도', phase: '제조전', auto: true },
  { key: 'manufacturing', label: '제조', title: '제조단계', phase: '제조', req: true, ocr: true },
  { key: 'distribution', label: '제품유통', title: '제품유통단계', phase: '제조 후', req: true, ocr: true },
  { key: 'usage', label: '사용', title: '사용단계', phase: '제조 후', auto: true },
  { key: 'waste-transport', label: '폐기수송', title: '폐기단계 · 수송', phase: '제조 후', auto: true },
  { key: 'waste', label: '폐기처리', title: '폐기단계 · 처리', phase: '제조 후', req: true, ocr: true },
